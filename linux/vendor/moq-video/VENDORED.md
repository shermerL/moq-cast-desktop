...
capture before encoding. It also adds an explicit H.264 profile option that
MoQCast sets to Baseline for broad decoder compatibility. These changes keep
the OpenH264 fallback within a 1080p output limit and avoid requiring an
unpublished moq-dev revision.
